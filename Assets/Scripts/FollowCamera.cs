...
public class FollowCamera : MonoBehaviour
{
    ...
    public float xMargin;      // 카메라가 따라 가기 전에 플레이어가 이동할 수있는 x 축의 거리.
    public float yMargin;      // 카메라가 따라 가기 전에 플레이어가 이동할 수있는 y 축의 거리.
    public float xSmooth;      // 카메라가 x 축에서 목표 이동을 따라 잡는 것이 얼마나 부드럽게 수행되는지.
    public float ySmooth;      // 카메라가 y 축에서 목표 이동을 따라 잡는 것이 얼마나 부드럽게 수행되는지.
    
    public Vector2 maxXAndY;   // 카메라가 가질 수있는 최대 x 및 y 좌표입니다.
    public Vector2 minXAndY;   // 카메라가 가질 수있는 최소 x 및 y 좌표입니다.
