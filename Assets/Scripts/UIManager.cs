...
public class UIManager : SingletonMono<UIManager>
{
 ...
 //            
 //            dicPool[ePoolType.UI]    = Utils.Search<RectTransform>(uiRootObject, ConstValues.UIPool);
 //            dicPool[ePoolType.Popup] = Utils.Search<RectTransform>(uiRootObject, ConstValues.PopupPool);
 //
 ...
 //    
 //    // 팝업창 열기
 //    private async void PopupControl()
 //    {
 //        if (Input.GetKeyDown(GameManager.Instance.optionKey))
 //            await OpenAsync(eUIType.UI_Skill, model);
 //    }
 //    
 //    #endregion
